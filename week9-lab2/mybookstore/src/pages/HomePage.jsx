...
import { getNewBooks, getFeaturedBooks } from '../data/booksData'; // ✅ ดึงข้อมูลจากไฟล์ data
const HomePage = () => {
  // ✅ ใช้ข้อมูลจากไฟล์ data
  const newBooks = getNewBooks(3);        // ดึงหนังสือใหม่ล่าสุด
  const featuredBooks = getFeaturedBooks(3); // ดึงหนังสือแนะนำ
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              ...
              >
                <div
                  className={`${category.color} h-40 flex flex-col items-center justify-center`}
                >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">หนังสือใหม่ล่าสุด</h2>
